...
export const venues: Venue[] = [
  ...
  {
    slug: "fulton-fish-market",
    name: "Fulton Fish Market",
    neighborhood: "Hunts Point, Bronx",
    address: "800 Food Center Drive, Bronx, NY 10474",
    subway: "6 train → Hunts Point Ave (then ~20min walk or rideshare)",
    subwayWalkMin: 25,
    capacity: "massive",
    capacityNum: 8000,
    indoorOutdoor: "outdoor",
    cashOnly: false,
    coatCheck: "N/A – outdoor",
    avgDrinkPrice: "$16–20",
    typicalDoorsDelay: "Sets start at listed time — daytime outdoor format",
    bathroomRating: 2.5,
    crowdTags: ["festival-crowd", "destination-event", "mixed", "serious-music"],
    dresscode: "Come as you are — weather-appropriate",
    description: "NYC's most unexpected festival ground: a working wholesale fish market by day that transforms into a massive outdoor venue beneath the Whitestone Bridge. Industrial, sprawling, atmospheric. Not easy to get to (plan for rideshare from the 6), but the effort filters the crowd. Best for big-name daytime and early-evening events with festival-scale production.",
    image: "/venues/fulton-fish-market.jpg",
    overallRating: 4.2,
    reviewCount: 23,
    stages: ["Main Stage", "Secondary Stage"],
  },
  {
    slug: "pacha-new-york",
    name: "Pacha New York",
    ...
    typicalDoorsDelay: "Sets start ~1.5hrs after doors",
    bathroomRating: 3.5,
    crowdTags: ["mixed", "dressed-up", "international", "house-music-heads", "ibiza-crowd"],
    dresscode: "Smart casual to dressed up — more polished than Avant Gardner was",
    description: "The former Brooklyn Mirage / Avant Gardner, now operated by Dubai-based FIVE Holdings as Pacha New York. Same physical footprint — Great Hall, the open-air main stage, Lost in Dreams — but elevated production, higher prices, and Pacha's Ibiza programming DNA. Summer 2026 is its inaugural season. Polarizing in the NYC underground: some mourn Avant Gardner's gritty legacy; others are genuinely excited for properly-funded world-class bookings.",
    image: "/venues/pacha-new-york.jpg",
    overallRating: 3.9,
    reviewCount: 0,
    stages: ["Great Hall", "Open Air Stage", "Lost in Dreams"],
  },
];
...
export const artists: Artist[] = [
  ...
  },
  {
    slug: "solomun",
    name: "Solomun",
    genres: ["Melodic Techno", "Deep House", "Electronica"],
    hometown: "Hamburg, Germany",
    spotifyFollowers: "2.8M",
    liveRating: 4.8,
    liveRatingCount: 127,
    description: "Diynamic Records boss and one of the most revered DJ/producers of his generation. Famous for marathon 6–8 hour sets that arc from deep, meditative opening to transcendent peak. Can fill a festival stage without losing the underground feeling. His Pacha Ibiza Solomun+1 residency is the stuff of legend — now bringing that energy to NYC.",
    image: "/artists/solomun.jpg",
    tags: ["marathon-sets", "melodic-techno", "festival-scale", "must-see", "arrive-early"],
  },
  {
    slug: "max-styler",
    name: "Max Styler",
    ...
    spotifyFollowers: "98K",
    liveRating: 4.2,
    liveRatingCount: 31,
    description: "LA-born, Europe-honed tech house producer with a Teksupport residency feel. Known for warm, driving sets that bridge underground and accessible. Understated name recognition for the quality he delivers — consistently rewarding.",
    image: "/artists/max-styler.jpg",
    tags: ["tech-house", "teksupport", "warehouse", "consistent"],
  },
  {
    slug: "black-coffee",
    name: "Black Coffee",
    ...
    spotifyFollowers: "4.1M",
    liveRating: 4.5,
    liveRatingCount: 218,
    description: "Grammy-winning South African DJ/producer who brought Afro house to the global stage. Sets are soulful, hypnotic, and emotionally charged in a way most electronic DJs can't touch. The Pacha New York opening weekend booking is a statement of intent — expect something spiritual.",
    image: "/artists/black-coffee.jpg",
    tags: ["afro-house", "soulful", "emotional", "global-star", "must-see"],
  },
  {
    slug: "michael-bibi",
    name: "Michael Bibi",
    genres: ["Tech House", "Deep Tech", "House"],
    hometown: "London, UK",
    spotifyFollowers: "1.6M",
    liveRating: 4.4,
    liveRatingCount: 89,
    description: "Solid Grooves label boss who helped define the modern intelligent tech house sound. DJ sets are groove-focused and never pander — he builds deliberately and trusts the crowd. Good bridge between the underground and a wider audience. Opening Night 1 at Pacha New York.",
    image: "/artists/michael-bibi.jpg",
    tags: ["tech-house", "groove-focused", "solid-grooves", "underground-adjacent"],
  },
];
...
export const events: Event[] = [
  ...
  {
    slug: "solomun-fulton-fish-market-may-23",
    name: "Solomun",
    venueSlug: "fulton-fish-market",
    date: "2026-05-23",
    time: "3pm",
    lineup: ["solomun"],
    ticketPrice: "$96–310",
    ticketUrl: "https://www.crowdvolt.com/event/solomun-may-23rd-may-fulton-fish-market-new-york",
    genres: ["Melodic Techno", "Deep House"],
    image: "/events/solomun-fulton.jpg",
    worthItScore: 0,
    worthItVotes: 0,
    avgSpend: "",
  },
  {
    slug: "teksupport-max-styler-brooklyn-storehouse-may-9",
    name: "Max Styler (Teksupport)",
    venueSlug: "brooklyn-storehouse",
    date: "2026-05-09",
    time: "10pm",
    lineup: ["max-styler"],
    ticketPrice: "$65–165",
    ticketUrl: "https://www.crowdvolt.com/event/teksupport-max-styler-brooklyn-storehouse-sat-may-9-new-york",
    genres: ["Tech House", "House"],
    image: "/events/max-styler-storehouse.jpg",
    worthItScore: 0,
    worthItVotes: 0,
    avgSpend: "",
  },
  {
    slug: "pacha-ny-michael-bibi-jun-20",
    name: "Pacha NY Opening: Michael Bibi",
    venueSlug: "pacha-new-york",
    date: "2026-06-20",
    time: "10pm",
    lineup: ["michael-bibi"],
    ticketPrice: "$160–500",
    ticketUrl: "https://dice.fm/event/avwvp2-michael-bibi-pacha-ny-opening-weekend-20th-jun-pacha-new-york-new-york-city-tickets",
    genres: ["Tech House", "Deep Tech"],
    image: "/events/michael-bibi-pacha.jpg",
    worthItScore: 0,
    worthItVotes: 0,
    avgSpend: "",
  },
  {
    slug: "pacha-ny-black-coffee-jun-21",
    name: "Pacha NY Opening: Black Coffee",
    venueSlug: "pacha-new-york",
    date: "2026-06-21",
    time: "10pm",
    lineup: ["black-coffee"],
    ticketPrice: "$150–550",
    ticketUrl: "https://dice.fm/event/wwd3gg-black-coffee-pacha-ny-opening-weekend-21st-jun-pacha-new-york-new-york-city-tickets",
    genres: ["Afro House", "Deep House"],
    image: "/events/black-coffee-pacha.jpg",
    worthItScore: 0,
    worthItVotes: 0,
    avgSpend: "",
  },
...
export const reviews: Review[] = [
  ...
  },
  {
    ...
    overallRating: 4.7,
    worthIt: true,
    text: "Saw Solomun at a festival in 2024 and I still think about it regularly. He played for 7 hours — started deep and almost ambient, built so slowly you didn't realize you were peaking until you were already past it. The outdoor setting worked in his favor. There was room to breathe, room to disappear. If you're on the fence about the Fulton Fish Market price tag, just pay it. Some artists are worth the premium and he is one of them.",
    tags: ["marathon-sets", "must-see", "buy-the-ticket", "outdoor", "arrive-early"],
    spend: "",
  },
  {
    id: "r8",
    type: "venue",
    targetSlug: "pacha-new-york",
    targetName: "Pacha New York",
    venueSlug: "pacha-new-york",
    venueName: "Pacha New York",
    authorName: "Mary A.",
    authorAvatar: "MA",
    date: "2026-04-05",
    crowdRating: 3,
    ...
    overallRating: 3.5,
    worthIt: null,
    text: "I have complicated feelings about this. The Mirage was everything when it was right — electric in a way that's hard to describe. Then they added the giant LED screen nobody asked for, started feeling like Vegas, and then came the bankruptcy. Now it's Pacha — Dubai money, Ibiza branding, $160 GA tickets. The space is still incredible and the production will be better than ever. But something gets lost when the pricing makes it a destination for people who want to say they were there, not people who live and breathe this music. Cautiously watching.",
    tags: ["expensive", "ibiza-vibes", "mirage-legacy", "controversial", "great-production"],
    spend: "",
  },
  {
    id: "r9",
    type: "artist",
    targetSlug: "max-styler",
    targetName: "Max Styler",
    authorName: "Jordan T.",
    authorAvatar: "JT",
    date: "2026-02-28",
    djRating: 4,
    ...
    overallRating: 4,
    worthIt: true,
    text: "Max Styler doesn't have the name recognition he deserves yet but he consistently delivers. Caught him at a Teksupport pop-up earlier this year — tight, driving set, excellent energy reading. Knew exactly when to drop and when to hold. Brooklyn Storehouse is the right room for him. This is exactly the kind of booking Teksupport keeps getting right: find the artist before everyone else does.",
    tags: ["teksupport", "consistent", "warehouse", "underground-find"],
    spend: "",
  },
  {
    id: "r10",
    type: "artist",
    targetSlug: "black-coffee",
    targetName: "Black Coffee",
    authorName: "Alex W.",
    authorAvatar: "AW",
    date: "2026-04-08",
    djRating: 5,
    ...
    overallRating: 4.7,
    worthIt: true,
    text: "Black Coffee is one of the few artists who can play to a massive crowd and still make it feel intimate. The Afro house influence gives his sets something most tech house DJs don't have — actual soul in the selection, a spiritual quality that builds over hours. Saw him at Coachella (not the ideal setting) and even then you could feel it. Whatever your feelings on the Pacha rebrand, Black Coffee at that outdoor stage on a June night is going to be something. This one is a buy.",
    tags: ["afro-house", "soulful", "must-see", "emotional", "buy-the-ticket"],
    spend: "",
  },
  {
    id: "r11",
    type: "venue",
    targetSlug: "fulton-fish-market",
    targetName: "Fulton Fish Market",
    venueSlug: "fulton-fish-market",
    venueName: "Fulton Fish Market",
    authorName: "Sam L.",
    authorAvatar: "SL",
    date: "2026-03-15",
    crowdRating: 4,
    ...
    overallRating: 4,
    worthIt: true,
    text: "Not what you'd expect. Went to an event here last summer and the setting is genuinely wild — industrial and sprawling, you can see the Whitestone Bridge from the floor. Getting there is a mission (6 train then a long walk or Uber) but that's part of what keeps the crowd right. People who made the trek to the Bronx aren't there to be seen. Sound was solid for an outdoor setup. Get there early, bring layers for when the sun drops.",
    tags: ["outdoor", "destination-event", "arrive-early", "industrial", "unique-setting"],
    spend: "",
  },
];
